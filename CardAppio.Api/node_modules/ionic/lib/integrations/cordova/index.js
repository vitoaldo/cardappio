...
class Integration extends __1.BaseIntegration {
    ...
    async add(details) {
        if (this.e.project.type === 'vue' || this.e.project.type === 'react') {
            throw new errors_1.FatalException(`Cordova is not supported for ${this.e.project.type} projects\n\n` +
                `See ${color_1.strong(`https://ionicframework.com/docs/${this.e.project.type}/overview`)} for detailed information.\n`);
        }
        const handlers = {
